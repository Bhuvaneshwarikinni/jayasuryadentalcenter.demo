...
import doctorSowmya from "@/assets/doctor-sowmya.png";
        ...
        {doctors.map((d) => (
          <div key={d.name} className="bg-card rounded-2xl overflow-hidden border border-border hover:shadow-lg transition-shadow">
            <div className="overflow-hidden h-72">
              <img src={d.image} alt={d.name} className="w-full h-full object-cover object-top scale-125" loading="lazy" width={512} height={640} />
            </div>
